        ...
        <div class="mt-16 grid lg:grid-cols-2 gap-14 items-start">
            ...
            <div>
                ...
                <div class="flex gap-4 mt-8">
                    ...
                    <!-- Instagram -->
                    <a
                        href="https://www.instagram.com/talkingkellytvshow?igsh=MWI5bWx1c2h5N2oyZA%3D%3D"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <!-- Facebook -->
                    <a
                        href="https://web.facebook.com/odokelvinmaduabuchi"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Facebook"
                ...
                <div class="mt-10">
                    ...
                    <ul class="list-disc pl-5 text-gray-700 space-y-2">
                        ...
                        <li>
                            Founder And CEO, Sivfit Ltd
                        </li>

                        <li>
                            Fitness Coach At TNH Gym (2024–2025)
                        </li>

                        <li>
                            Founder, Health Watch Podcast On Radio
                        </li>
